...
class SlidingWindowDataset(Dataset):
    def __init__(self, skeleton_data, sensor1_data, common_files, window_size, overlap, label_encoder, scaling="minmax"):
        ...
        self.skeleton_windows, self.sensor1_windows, self.labels = self._create_windows()
    ...
    def _create_windows(self):
        skeleton_windows, sensor1_windows, labels = [], [], []
        ...
        for file in self.common_files:
            ...
            for i in range(num_windows):
                ...
                if skeleton_window.shape[0] != self.window_size or sensor1_window.shape[0] != self.window_size:
                    continue
        ...
        skeleton_windows_oversampled, sensor1_windows_oversampled, labels_oversampled = [], [], []
        ...
        for lbl, indices in class_indices.items():
            ...
            for idx in selected_indices:
                ...
                labels_oversampled.append(to_one_hot(lbl, num_classes))

        return skeleton_windows_oversampled, sensor1_windows_oversampled, labels_oversampled
